...
class FormBuilderChipsInput<T> extends FormBuilderField<List<T>> {
  ...
  final bool showSuggestionInitial;
  ...
  FormBuilderChipsInput({
    ...
    this.showSuggestionInitial = true,
  }) : super(
          key: key,
          ...
          builder: (FormFieldState<List<T>?> field) {
            ...
            return ChipsInput<T>(
              ...
              showSuggestionInitial: showSuggestionInitial,
            );
          },
        );
...
class ChipsInputState<T> extends State<ChipsInput<T>>
  ...
  void _handleFocusChanged() {
    if (_effectiveFocusNode.hasFocus) {
      ...
      if (widget.showSuggestionInitial) {
        _onSearchChanged('');
      }
  ...
  void updateEditingValue(TextEditingValue value) {
    final oldCount = _value.replacementCharactersCount;
    final newCount = value.replacementCharactersCount;
    setState(() {
